...
test.serial('Create a single host', (() => {
	var _ref4 = _asyncToGenerator(function* (t) {
		...
		var res = yield request('http://localhost:8080').post('/host').set('Content-Type', 'application/json').send(host_str);

		t.is(res.status, 201);
		t.is(res.header.location, "/host/0");

		res = yield request('http://localhost:8080').get('/host/44').set('Accept', 'application/json');
...
test.serial('Update a single host', (() => {
	var _ref5 = _asyncToGenerator(function* (t) {
		...
		var res = yield request('http://localhost:8080').put('/host/103').set('Content-Type', 'application/json').send(host_str);

		t.is(res.status, 200);

		res = yield request('http://localhost:8080').get('/host/103').set('Accept', 'application/json');
...
test.serial('Delete a single host', (() => {
	var _ref6 = _asyncToGenerator(function* (t) {
		...
		var res = yield request('http://localhost:8080').delete('/host/1').set('Accept', 'application/json');

		t.is(res.status, 200);

		res = yield request('http://localhost:8080').get('/host/1').set('Accept', 'application/json');
...
test.serial('Delete all hosts', (() => {
	var _ref7 = _asyncToGenerator(function* (t) {
		...
		var res = yield request('http://localhost:8080').delete('/hosts').set('Accept', 'application/json');

		t.is(res.status, 200);

		res = yield request('http://localhost:8080').get('/hosts').set('Accept', 'application/json');
...
test.only('Delete selected hosts', (() => {
	var _ref8 = _asyncToGenerator(function* (t) {
		...
		var res = yield request('http://localhost:8080').delete('/hosts').set('Content-Type', 'application/json').send(hosts_to_del);
		...
		console.log(JSON.stringify(hosts.hosts));

		t.is(res.status, 200);
		t.is(hosts.hosts.length, 1);
	});
...
//# sourceMappingURL=..\node_modules\.cache\ava\2c6a5e29cbdd78e2d2aaf0fdfdebde3b.js.map