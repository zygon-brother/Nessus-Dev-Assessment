...
test.only('Delete selected hosts', (() => {
	var _ref8 = _asyncToGenerator(function* (t) {
		...
		var hosts_to_del = JSON.stringify({ "hosts": [{ "id": 103 }, { "id": 1 }] });

		var res = yield request('http://localhost:8080').delete('/hosts').set('Accept', 'application/json').send(hosts_to_del);
...
//# sourceMappingURL=..\node_modules\.cache\ava\bcdb0ac127513c74e66b89d17e97ea14.js.map