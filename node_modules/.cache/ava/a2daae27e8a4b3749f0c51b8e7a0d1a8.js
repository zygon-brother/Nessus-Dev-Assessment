...
test.only('Create a single host', (() => {
	var _ref4 = _asyncToGenerator(function* (t) {
		...
		const res = yield request('http://localhost:8080').post('/host').set('Content-Type', 'application/json').type('json').send(host);
...
//# sourceMappingURL=..\node_modules\.cache\ava\a2daae27e8a4b3749f0c51b8e7a0d1a8.js.map