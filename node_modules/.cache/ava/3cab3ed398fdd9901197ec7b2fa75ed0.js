...
test.only('Create a single host', (() => {
	var _ref4 = _asyncToGenerator(function* (t) {
		...
		const res = yield request('http://localhost:8080').post('/host').set('Content-Type', 'application/json').send(host);
...
//# sourceMappingURL=..\node_modules\.cache\ava\3cab3ed398fdd9901197ec7b2fa75ed0.js.map