...
test.only('Update a single host', (() => {
	var _ref5 = _asyncToGenerator(function* (t) {
		...
		const res = yield request('http://localhost:8080').put('/host/103').set('Content-Type', 'application/json').send(host_str);

		console.out(res.text);
...
//# sourceMappingURL=..\node_modules\.cache\ava\69e6c1ce8cd2ecab05a6dc1d00e737e4.js.map