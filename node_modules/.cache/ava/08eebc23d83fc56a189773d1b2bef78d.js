...
test.only('Create a single host', (() => {
	var _ref4 = _asyncToGenerator(function* (t) {
		...
		const res = yield request('http://localhost:8080').post('/host').set('Content-Type', 'application/json').type('form').send(host);
...
//# sourceMappingURL=..\node_modules\.cache\ava\08eebc23d83fc56a189773d1b2bef78d.js.map