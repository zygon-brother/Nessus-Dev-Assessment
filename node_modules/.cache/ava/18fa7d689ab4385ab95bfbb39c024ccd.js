...
tests.only('Create a single host', (() => {
	var _ref4 = _asyncToGenerator(function* (t) {
		...
		const res = yield request('http://localhost:8080').post('/host').set('Content-Type', '/json/').send(host);
...
//# sourceMappingURL=..\node_modules\.cache\ava\18fa7d689ab4385ab95bfbb39c024ccd.js.map